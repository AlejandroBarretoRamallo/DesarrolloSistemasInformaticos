function romanToDecimal(string: string): number | undefined {
  if (/[^IVXLCDM]/.test(string)) return undefined;
  if (/IIII|XXXX|CCCC|MMMM/.test(string)) return undefined;
  if (/VV|LL|DD/.test(string)) return undefined;
...
function decimalToRoman(number: number): string | undefined {
